      ...
      <div className="rounded-t mb-0 px-4 py-3 border-0">
        <div className="flex flex-wrap items-center">
          ...
          <div className="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
            <Link className="bg-green-500 text-white active:bg-green-800 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button" href="contact/create">CREAR CONTACTO</Link>
          </div>
        </div>
      </div>
              ...
              <tr key={`listTable-${contact.id}`}>
                ...
                <td className="border-t-0 px-6 align-center border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                  <div className="flex">
                    ...
                    <Link href={`contact/edit/${contact.id}`} className="w-4 mr-2 transform hover:text-purple-500 hover:scale-110 cursor-pointer">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
